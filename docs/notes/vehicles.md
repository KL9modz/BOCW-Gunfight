...
✅ **Done 2026-09-23 (fun pack):** nine resident rows **appended** at indices 67–75 (`Catalog.cs` synced,
76 rows): `heli_ai_mp`, `veh_missile_turret`, `veh_ultimate_turret` — all maps, named above — plus
`hash_444804d03bdda785` and `hash_7dd2944ddf7cc7e9` (all maps; Project HiNAtyu's menu labels them *Drone
