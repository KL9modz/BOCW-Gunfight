...
| `game-systems.md` | **how the game works / mod expansion reference**: Gunfight anatomy, clientfield sync (+ the joiner-reach correction), builtins, events, zones, injection surface (§10), loadouts (§11), the expansion roadmap (§9) |
