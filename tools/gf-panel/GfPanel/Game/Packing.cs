...
public static class Packing
{
    ...
    public static readonly string[] DbgOrder = { "gf_dbg_race", "gf_dbg_veh", "gf_dbg_barrier", "gf_mapscan", "gf_dbg_buttons" };
    public static readonly string[] MiscOrder = { "gf_spawn_antistack", "gf_hint_lines", "gf_respawns", "gf_hint_others_on", "gf_hint_glyphs", "gf_forge_pin", "gf_forge_movestep", "gf_forge_rotstep", "gf_forge_scalestep", "gf_forge_zstep", "gf_hint_self_on", "gf_menu_repaint", "gf_rounds_sides", "gf_friendlyfire", "gf_latejoin", "gf_teamchange", "gf_place_dist", "gf_grab_dist", "gf_ahint", "gf_radar", "gf_parachute", "gf_invwall", "gf_match_minutes", "gf_melee", "gf_ping", "gf_wraith_mode" };   // append-only (the GSC misc= list; gf_radar + gf_parachute bocw-84 2026-09-23, gf_invwall 2026-09-24, gf_match_minutes bocw-e0 2026-09-24)
